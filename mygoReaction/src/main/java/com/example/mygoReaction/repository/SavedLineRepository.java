...
public interface SavedLineRepository extends JpaRepository<SavedLineEntity,String> {
    ...
    @Query("Select sle.savedLineId as savedLineId, sle.seriesId as seriesId, sle.startTime as startTime, sle.endTime as endTime, sle.line as line from SavedLineEntity sle where (:seriesId is null or :seriesId = seriesId) and line like %:keyword%")
